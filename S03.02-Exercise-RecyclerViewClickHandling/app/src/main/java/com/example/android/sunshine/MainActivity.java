...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler {
    ...
    @Override
    public void onListClickListener(String weatherForecastDay) {
        if (mToastClickDay != null) {
            mToastClickDay.cancel();
        }

        mToastClickDay = Toast.makeText(this, weatherForecastDay, Toast.LENGTH_SHORT);
        mToastClickDay.show();
