...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        mTempHight = (TextView) findViewById(R.id.temperature_high);
        mTempLow = (TextView) findViewById(R.id.temperature_low);
