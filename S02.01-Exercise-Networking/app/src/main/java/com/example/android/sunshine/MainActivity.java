...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData() {
        ...
        new NetworkRequest().execute(NetworkUtils.buildUrl(preferredLocation));
    }
    ...
    public class NetworkRequest extends AsyncTask<URL, Void, String[]> {
        ...
        protected String[] doInBackground(URL... urls) {
            URL url = urls[0];
            String[] jsonDataWeather = null;
            String weatherResult;
            try {
                weatherResult = NetworkUtils.getResponseFromHttpUrl(url);
                jsonDataWeather = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherResult);
            } catch (IOException e) {
                e.printStackTrace();
        ...
        @Override
        protected void onPostExecute(String[] jsonDataWeather) {
            if (jsonDataWeather != null) {
                for (String weatherString : jsonDataWeather) {
